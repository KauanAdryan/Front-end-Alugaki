...
export const equipamentosData: Equipamento[] = [
  { 
    ...
    local: "São Paulo",
    categoria: "cordas",
    imagem: "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=500&h=500&fit=crop",
    disponivel: true,
    avaliacao: 4.8,
  ...
  { 
    ...
    categoria: "cordas",
    imagem: "https://images.unsplash.com/photo-1511735111819-9a3f7709049c?w=500&h=500&fit=crop",
    disponivel: true,
    avaliacao: 4.6,
  ...
  { 
    ...
    imagem: "https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?w=500&h=500&fit=crop",
    disponivel: true,
    avaliacao: 4.9,
  ...
  { 
    ...
    categoria: "som",
    imagem: "https://images.unsplash.com/photo-1470229722913-7c0e2dbbafd3?w=500&h=500&fit=crop",
    disponivel: false,
    avaliacao: 4.7,
  ...
  { 
    ...
    local: "Curitiba",
    categoria: "teclas",
    imagem: "https://images.unsplash.com/photo-1520523839897-bd0b52f945a0?w=500&h=500&fit=crop",
    disponivel: true,
    avaliacao: 4.5,
  ...
  { 
    ...
    local: "Porto Alegre",
    categoria: "percussao",
    imagem: "https://images.unsplash.com/photo-1519892300165-cb5542fb47c7?w=500&h=500&fit=crop",
    disponivel: true,
    avaliacao: 4.8,
  ...
  { 
    ...
    local: "Rio de Janeiro",
    categoria: "som",
    imagem: "https://images.unsplash.com/photo-1598488035139-bdbb2231ce04?w=500&h=500&fit=crop",
    disponivel: true,
    avaliacao: 4.9,
